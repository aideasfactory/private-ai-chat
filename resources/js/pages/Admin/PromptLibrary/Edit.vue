...
const submit = () => {
    form.put(route('admin.prompt-library.update', props.prompt.id), {
        onSuccess: () => {
...
<template>
    <AppLayout>
        <Head :title="`Edit Prompt: ${prompt.title}`" />
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 max-w-2xl text-sm text-gray-500">
                                        Update the approved prompt template
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-center gap-2 text-sm text-gray-500">
                                <span v-if="prompt.category.icon">{{ prompt.category.icon }}</span>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    ...
                                    <span class="ml-2 font-medium">{{ prompt.usage_count || 0 }}</span>
                                </div>
                                <div>
